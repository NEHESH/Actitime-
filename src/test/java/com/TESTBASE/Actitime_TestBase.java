...
public class Actitime_TestBase {
	...
	public static ExcelReader e1 = new ExcelReader(
			System.getProperty("user.dir") + "\\src\\test\\resources\\testDATA\\Actitime_new.xlsx");
	...
	public static Object[][] Data_Collections() {
		DataCollection d1 = new DataCollection(e1, "Sheet3", "TC_ACTI_007_Create_an_Account_build");
		return d1.dataArray();
	}
	...
	public static void screenShots() throws Exception {
		...
		String ReportDirectory = new File(System.getProperty("user.dir")).getAbsolutePath()
				+ "\\src\\test\\resources\\screenShotss\\ScreenShot____" + timeStamp + ".png";
